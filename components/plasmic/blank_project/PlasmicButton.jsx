...
import sty from "./PlasmicButton.module.css"; // plasmic-import: YWPWm_cPIbY/css
import ChecksvgIcon from "./icons/PlasmicIcon__Checksvg"; // plasmic-import: 9n7c9nus0A9/icon
import IconIcon from "./icons/PlasmicIcon__Icon"; // plasmic-import: s7KK4jNn_4k/icon
      ...
      {(
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <ChecksvgIcon
                className={classNames(projectcss.all, sty.svg__o29Ah)}
                role={"img"}
              />
            ),
      ...
      {(hasVariant(variants, "showEndIcon", "showEndIcon") ? true : false) ? (
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <IconIcon
                className={classNames(projectcss.all, sty.svg___0Pv8)}
                role={"img"}
              />
            ),
